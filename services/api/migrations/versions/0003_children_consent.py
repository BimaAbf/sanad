...
CONSENTS: tuple[tuple[str, str, str, bool], ...] = (
    (
        "data_processing",
        "أوافق إن مِسك يحفظ بيانات طفلي وتقدّمه.",
        "I agree that Misk may store my child's profile and progress.",
        True,
    ),
    (
        "ai_processing",
        "أوافق إن مِسك يبعت نصوص من غير أسماء لمساعد ذكي عشان يساعد في التقييم.",
        "I agree that Misk may send pseudonymised text to an AI assistant to support assessment.",
        True,
    ),
    (
        "terms_not_medical",
        "فاهم إن مِسك مش خدمة طبية ولا بيشخّص.",
        "I understand that Misk is not a diagnostic or medical service.",
        True,
    ),
    (
        "voice_asr",
        "أوافق إن مِسك يحوّل كلام طفلي لنص عشان يتأكد من النطق. الصوت مش بيتخزن.",
        "I agree that Misk may transcribe my child's speech. The audio is not retained.",
        False,
    ),
    (
        "voice_retention",
        "أوافق إن مِسك يحتفظ بصوت طفلي ٣٠ يوم عشان يتحسّن التعرّف على كلامه.",
        "I agree that Misk may keep 30 days of audio to improve recognition for this child.",
        False,
    ),
    (
        "clinician_share",
        "أوافق إن مِسك يشارك تقارير طفلي مع الأخصائي المرتبط بحسابي.",
        "I agree that Misk may share my child's reports with a linked clinician.",
        False,
    ),
    (
        "research_aggregate",
