"""VIOLATION FIXTURE — required-guardrail-layer guard must FAIL on this file.

pgee_report produces prose a caregiver reads AND restates computed numbers, so
it needs both ClinicalSafetyLayer and NumericEqualityLayer. Only one is here.
"""
...
LAYERS = {
    ...
    "pgee_report": [ClinicalSafetyLayer],
